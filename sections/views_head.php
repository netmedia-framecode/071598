...
<title>
  <?= $name_website ?> <?php if (isset($_SESSION['project_plbn_motamasin']['name_page'])) {
                          if (!empty($_SESSION['project_plbn_motamasin']['name_page'])) {
                            echo " - " . $_SESSION['project_plbn_motamasin']['name_page'];
                          }
                        } ?>
</title>
