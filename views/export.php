<?php require_once("../controller/export.php");
$_SESSION["project_plbn_motamasin"]["name_page"] = "Export";
                      ...
                      <div class="modal-content">
                        ...
                        <form action="" method="post">
                          ...
                          <div class="modal-footer justify-content-center border-top-0">
                            ...
                            <button type="submit" name="edit_export" class="btn btn-warning btn-sm">Ubah</button>
                          </div>
                        </form>
                      </div>
                    </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form action="" method="post">
                          ...
                          <div class="modal-footer justify-content-center border-top-0">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Batal</button>
                            <button type="submit" name="delete_export" class="btn btn-danger btn-sm">hapus</button>
                          </div>
                        </form>
                      </div>
                    </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="" method="post">
          ...
          <div class="modal-footer justify-content-center border-top-0">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Batal</button>
            <button type="submit" name="add_export" class="btn btn-primary btn-sm">Tambah</button>
          </div>
        </form>
      </div>
    </div>
